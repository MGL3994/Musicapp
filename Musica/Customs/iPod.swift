...
struct ipod_search: View {
    ...
    @Binding var editing_state: String
    private let gradient = LinearGradient(gradient: Gradient(colors: [.white, .white]), startPoint: .top, endPoint: .bottom)
    private let cancel_gradient = LinearGradient(
        gradient: Gradient(stops: [
            Gradient.Stop(color: Color(red: 164/255, green: 175/255, blue:191/255), location: 0),
            Gradient.Stop(color: Color(red: 124/255, green: 141/255, blue:164/255), location: 0.51),
            Gradient.Stop(color: Color(red: 113/255, green: 131/255, blue:156/255), location: 0.51),
            Gradient.Stop(color: Color(red: 112/255, green: 130/255, blue:155/255), location: 1)]),
